...
mkdir "welcompose-0.8.2-$BUILD_NUMBER"
...
tar cvfz "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2-full-src".tar.gz welcompose-0.8.2
tar cvfj "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2-full-src".tar.bz2 welcompose-0.8.2
zip -r "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2-full-src".zip welcompose-0.8.2

# rename welcompose to match reverse 
mv welcompose-0.8.2 welcompose
...
tar cvfz "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2-src".tar.gz welcompose-0.8.2
tar cvfj "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2-src".tar.bz2 welcompose-0.8.2
zip -r "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2-src".zip welcompose-0.8.2
...
mkdir welcompose-0.8.2

# move installer files to welcompose directory
mv install-zlib.php welcompose-0.8.2
mv install.php welcompose-0.8.2

# create tarball (gzipped and bzipped) & zip file
tar cvfz "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2".tar.gz welcompose-0.8.2
tar cvfj "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2".tar.bz2 welcompose-0.8.2
zip -r "../welcompose-0.8.2-$BUILD_NUMBER/welcompose-0.8.2".zip welcompose-0.8.2
