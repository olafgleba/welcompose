...
mkdir "welcompose-0.8.4-$BUILD_NUMBER"
...
mv welcompose welcompose-0.8.4

# create full source packages
tar cvfz "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4-full-src".tar.gz welcompose-0.8.4
tar cvfj "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4-full-src".tar.bz2 welcompose-0.8.4
zip -r "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4-full-src".zip welcompose-0.8.4

# rename welcompose to match reverse 
mv welcompose-0.8.4 welcompose
...
tar cvfz "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4-src".tar.gz welcompose-0.8.4
tar cvfj "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4-src".tar.bz2 welcompose-0.8.4
zip -r "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4-src".zip welcompose-0.8.4
...
mkdir welcompose-0.8.4

# move installer files to welcompose directory
mv install-zlib.php welcompose-0.8.4
mv install.php welcompose-0.8.4

# create tarball (gzipped and bzipped) & zip file
tar cvfz "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4".tar.gz welcompose-0.8.4
tar cvfj "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4".tar.bz2 welcompose-0.8.4
zip -r "../welcompose-0.8.4-$BUILD_NUMBER/welcompose-0.8.4".zip welcompose-0.8.4
...
for i in `find welcompose-0.8.4-$BUILD_NUMBER -type f -name "*"` ; do
	md5 $i >> "welcompose-0.8.4-$BUILD_NUMBER/checksum.txt"
done
