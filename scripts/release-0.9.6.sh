...
mkdir "welcompose-0.9.6-$BUILD_NUMBER"
...
mv welcompose welcompose-0.9.6

# create full source packages width compressed js and css
tar cvfz "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6-full-src".tar.gz welcompose-0.9.6
tar cvfj "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6-full-src".tar.bz2 welcompose-0.9.6
zip -r "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6-full-src".zip welcompose-0.9.6

# rename welcompose to match reverse 
mv welcompose-0.9.6 welcompose
...
tar cvfz "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6-src".tar.gz welcompose-0.9.6
tar cvfj "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6-src".tar.bz2 welcompose-0.9.6
zip -r "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6-src".zip welcompose-0.9.6
...
mkdir welcompose-0.9.6

# move installer files to welcompose directory
mv install-zlib.php welcompose-0.9.6
mv install.php welcompose-0.9.6

# create tarball (gzipped and bzipped) & zip file
tar cvfz "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6".tar.gz welcompose-0.9.6
tar cvfj "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6".tar.bz2 welcompose-0.9.6
zip -r "../welcompose-0.9.6-$BUILD_NUMBER/welcompose-0.9.6".zip welcompose-0.9.6
...
for i in `find welcompose-0.9.6-$BUILD_NUMBER -type f -name "*"` ; do
	md5 $i >> "welcompose-0.9.6-$BUILD_NUMBER/checksum.txt"
done
