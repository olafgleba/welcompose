...
protected function _urlTranslationTable ()
{
	return array (
				// german
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤' => 'ae',
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼' => 'ue',
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶' => 'oe',
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ' => 'ss',
				// french
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¨' => 'e',
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©' => 'e',
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ' => 'a',
				// spanish
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±' => 'n',
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡' => 'a',
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©' => 'e',		
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­' => 'i',		
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³' => 'o',		
				'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº' => 'u',
			);
}
