...
// define constants
define('BASE_ERROR_ERROR', PEAR_LOG_ERR);
...
public function displayException (&$error_object, &$smarty, $template = 'error.html')
{
 ...
 /**
 * Will print an exception error message while returning ajax 
 * callbacks. Takes the exception object as first argument.
 * Please note that printExceptionMessage() does not stop script execution.
 * 
 * @param object error object
 */
public function printExceptionMessage (&$error_object)
{
	// pass exception information to smarty
	print $error_object->getMessage();
}
