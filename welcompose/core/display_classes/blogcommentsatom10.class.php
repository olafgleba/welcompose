 ...
 * @return object
 */
function Display_BlogCommentsAtom10 ($args)
{
	// check input
	if (!is_array($args)) {
	...
	return new Display_BlogCommentsAtom10($args[0], $args[1]);
}

class Display_BlogCommentsAtom10 implements Display {
 ...
 * argument.
 * 
 * @throws Display_BlogCommentsAtom10Exception
...
public function __construct($project, $page)
{
	...
	// input check
	if (!is_array($project)) {
		throw new Display_BlogCommentsAtom10Exception("Input for parameter project is expected to be an array");
	}
	if (!is_array($page)) {
		throw new Display_BlogCommentsAtom10Exception("Input for parameter page is expected to be an array");
	}
...
public function getMainTemplateName ()
{
	...
	return "wcom:blog_comments_atom10.".WCOM_CURRENT_PAGE;
}
...
class Display_BlogCommentsAtom10ExceptionException extends Exception { }
