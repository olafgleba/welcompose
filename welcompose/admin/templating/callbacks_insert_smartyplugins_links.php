 ...
 *
 * @copyright 2008 - 2011 creatics, Olaf Gleba
 * @author Olaf Gleba
 * @package Welcompose
...
try {
	...
	// no check access as there is nothing to check for 
	// if (!wcom_check_access('Templating', 'StructuralTemplate', 'Use')) {
	...
	// display the page
	$BASE->utility->smarty->display('templating/callbacks_insert_smartyplugins_links.html');
