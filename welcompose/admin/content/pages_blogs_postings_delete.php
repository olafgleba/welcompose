...
try {
	...
	try {
		...
		// delete tags
		$BLOGTAG->deletePostingTags(Base_Cnc::filterRequest($_REQUEST['page'], WCOM_REGEX_NUMERIC), 
			Base_Cnc::filterRequest($_REQUEST['id'], WCOM_REGEX_NUMERIC));
		
		// delete row
		$BLOGPOSTING->deleteBlogPosting(Base_Cnc::filterRequest($_REQUEST['id'], WCOM_REGEX_NUMERIC));
	...
	header("Location: pages_blogs_postings_select.php?page=".(int)$page['id'].$redirect_params);
	exit;
