...
/**
 * Project: Welcompose
 * File: pages_events_postings_delete.php
 *
...
try {
	...
	try {
		...
		// delete tags
		$EVENTTAG->deletePostingTags(Base_Cnc::filterRequest($_REQUEST['page'], WCOM_REGEX_NUMERIC), 
			Base_Cnc::filterRequest($_REQUEST['id'], WCOM_REGEX_NUMERIC));
		
		// delete row
		$EVENTPOSTING->deleteEventPosting(Base_Cnc::filterRequest($_REQUEST['id'], WCOM_REGEX_NUMERIC));
