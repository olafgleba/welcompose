...
/**
 * Project: Welcompose
 * File: pages_simple_dates_select.php
 *
...
try {
	...
	// get blog postings
	$simple_dates = $SIMPLEDATE->selectSimpleDates(array(
	...
	$date_count = $SIMPLEDATE->countSimpleDates($select_params);
	$BASE->utility->smarty->assign('date_count', $date_count);
	...
	$total_date_count = $SIMPLEDATE->countSimpleDates($select_params);
	$BASE->utility->smarty->assign('total_date_count', $total_date_count);
	
	// prepare and assign page index
	$BASE->utility->smarty->assign('page_index', $HELPER->calculatePageIndex($date_count, 20));
	...
	$BASE->utility->smarty->display('content/pages_simple_dates_select.html', WCOM_TEMPLATE_KEY);
