...
try {
	...
	try {
		...
		// delete row
		$GENERATORFORMFIELD->deleteGeneratorFormField(Base_Cnc::filterRequest($_REQUEST['id'], WCOM_REGEX_NUMERIC));
	...
	header("Location: pages_generatorforms_fields_select.php?page=".(int)$page['id']);
	exit;
