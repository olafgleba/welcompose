...
/**
 * Project: Welcompose
 * File: structuraltemplates_select.php
 *
...
try {
	...
	$select_params = array(
		'order_macro' => 'NAME:ASC',
		'start' => Base_Cnc::filterRequest($_REQUEST['start'], WCOM_REGEX_NUMERIC),
		'limit' => 20
	);
	$BASE->utility->smarty->assign('structural_templates',
		$STRUCTURALTEMPLATE->selectStructuralTemplates($select_params));
	
	// count available boxes
	$template_count = $STRUCTURALTEMPLATE->countStructuralTemplates();
	...
	$BASE->utility->smarty->display('content/structuraltemplates_select.html', WCOM_TEMPLATE_KEY);
