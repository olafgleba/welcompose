...
try {
	...
	$FORM->addRule('name', gettext('Please enter a valid name'), 'regex', WCOM_REGEX_RIGHT_NAME);
	$FORM->addRule('name', gettext('A right with this name already exists'),
	...
	// submit button
	$FORM->addElement('submit', 'submit', gettext('Edit right'),
