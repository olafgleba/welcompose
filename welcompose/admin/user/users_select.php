...
try {
	...
	// get existing users
	$select_params = array(
		'group' => Base_Cnc::filterRequest($_REQUEST['group'], WCOM_REGEX_NUMERIC)
	);
	$BASE->utility->smarty->assign('users', $USER->selectUsers($select_params));
	
	// display the page
	define("WCOM_TEMPLATE_KEY", md5($_SERVER['REQUEST_URI']));
	$BASE->utility->smarty->display('user/users_select.html', WCOM_TEMPLATE_KEY);
