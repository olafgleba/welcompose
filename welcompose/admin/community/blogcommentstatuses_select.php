...
/**
 * Project: Welcompose
 * File: blogcommentstatuses_select.php
 *
...
try {
	...
	$BASE->utility->smarty->assign('page_index', $HELPER->calculatePageIndex($status_count, 20));
	...
	$BASE->utility->smarty->display('community/blogcommentstatuses_select.html', WCOM_TEMPLATE_KEY);
