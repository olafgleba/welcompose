...
try {
	...
	$FORM->addDataSource(new HTML_QuickForm2_DataSource_Array(array(
		'id' => Base_Cnc::ifsetor($blog_comment_status['id'], null),
		'name' => Base_Cnc::ifsetor($blog_comment_status['name'], null)
	)));
	...
	if (!$FORM->validate()) {
		...
		try {
			...
			// execute operation
			$BLOGCOMMENTSTATUS->updateBlogCommentStatus($id->getValue(),
				$sqlData);
