...
/**
 * Project: Welcompose
 * File: blogcomments_statuschange.php
 *
...
try {
	...
	try {
		...
		// import params
		$comment_id = Base_Cnc::filterRequest($_REQUEST['comment_id'], WCOM_REGEX_NUMERIC);
		$status_id = Base_Cnc::filterRequest($_REQUEST['status_id'], WCOM_REGEX_NUMERIC);
