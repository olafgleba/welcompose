...
var confirmMsgDelProject = '<%i18n Are you sure you want to delete the chosen project? Every page and template within this project will deleted too.%>';
...
var confirmMsgDelUser = '<%i18n Are you sure you want to delete the chosen user?%>';
var confirmMsgDelBlogPosting = '<%i18n Are you sure you want to delete this Blog Posting?%>';
var confirmMsgDelEventPosting = '<%i18n Are you sure you want to delete this Event Posting?%>';
