...
try {
	 ...
	 * ----------
	 *
	 * Commit: f48ab1f3c57b17c487e351004485892bfab219ef
	 * Ticket: 47
	 * 
	 * Changes to be applied
	 * ---------------------
	 *
	 * - Add three new optional text fields to table 'content_blog_postings'
	...
	if ($major < TASK_MAJOR || ($major == TASK_MAJOR && $minor < TASK_MINOR)) {
		try {
			...
			$sql = "
				...
				text
					NULL DEFAULT NULL
					AFTER `optional_content_1`,
				ADD
					`optional_content_3`
				text
					NULL DEFAULT NULL
					AFTER `optional_content_2`
			";
