...
try {
	 ...
	 * ---------------------
	 *
	 * - Insert default embed_video text macro to table WCOM_DB_APPLICATION_TEXT_MACROS
	 */
		...
		try {
			...
			foreach ($projects as $_project) {
				...
				$sqlData = array(
					...
					'name' => 'Bundled Embed Video Generator',
					'internal_name' => 'embed_video',
					'type' => 'pre',
					'editable' => '0'
				);
