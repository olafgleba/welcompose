...
public function __construct($project_info, $page_info)
{
	...
	if (!is_array($project_info)) {
		throw new Display_BlogIndexException("Input for parameter project_info is expected to be an array");
	}
	if (!is_array($page_info)) {
		throw new Display_BlogIndexException("Input for parameter page_info is expected to be an array");
	}
...
{
	return new Display_BlogIndex($project_info, $page_info);
}
