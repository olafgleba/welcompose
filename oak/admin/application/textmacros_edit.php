...
try {
	...
	// get text macro
	$text_macro = $TEXTMACRO->selectTextMacro(Base_Cnc::filterRequest($_REQUEST['id'], OAK_REGEX_NUMERIC));
	...
	if (!$FORM->validate()) {
		...
		$BASE->utility->smarty->display('application/textmacros_edit.html', OAK_TEMPLATE_KEY);
