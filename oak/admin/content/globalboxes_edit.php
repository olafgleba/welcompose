...
try {
	...
	// get global box
	$global_box = $GLOBALBOX->selectGlobalBox(Base_Cnc::filterRequest($_REQUEST['id'], OAK_REGEX_NUMERIC));
	...
	if (!$FORM->validate()) {
		...
		$BASE->utility->smarty->display('content/globalboxes_edit.html', OAK_TEMPLATE_KEY);
